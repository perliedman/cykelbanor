...
local elevation = require("lib/elevation")

local slope_file = io.open( '/home/per/Documents/geodata/sweden_slope.json', "r" )
local contents = slope_file:read( "*a" )
local slope_table = cjson.decode(contents);
io.close( slope_file )
